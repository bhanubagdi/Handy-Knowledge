...
public class Sem3Sub extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //----------------------------------------------------
       setContentView(R.layout.first); 
        ...
        String[] subjects = new String[] {"Discrete Structures","Data Structures and Problem Solving","Digital Electronics and Logic Design","Operating System and Administration","Microprocessor Architecture","Soft Skills"};    
