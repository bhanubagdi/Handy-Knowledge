...
public class Sem6Sub extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //----------------------------------------------------
       setContentView(R.layout.first); 
        ...
        String[] subjects = new String[] {"Principles of Programming Languages","Computer Networks","Finance and Management Information Systems","Systems Programming & Operating Systems","Software Engineering"};    
