...
public class Sem5Sub extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //----------------------------------------------------
       setContentView(R.layout.first); 
        ...
        String[] subjects = new String[] {"Database Management Systems","Data Communications","Microprocessors and Microcontrollers","Digital Signal Processing","Theory of Computation"};    
