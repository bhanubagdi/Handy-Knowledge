    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //----------------------------------------------------
       setContentView(R.layout.first); 
        ...
        String[] planets = new String[] { "Third Semester", "Fourth Semester"};    
        ...
        {
           case 0:  
        	   Intent newActivity0 = new Intent(getBaseContext(), Sem3Sub.class);     
                    startActivity(newActivity0);
                    break;
           case 1:  Intent newActivity1 = new Intent(getBaseContext(), Sem4Sub.class);     
