...
public class Sem2Sub extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //----------------------------------------------------
       setContentView(R.layout.first); 
        ...
        String[] subjects = new String[] {"Engineering Mathematics II","Fundamentals of Programming languages II","Engineering Mechanics","Basic Mechnical Engineering","Engineering Graphics II"};    
