    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //----------------------------------------------------
       setContentView(R.layout.first); 
        ...
        String[] planets = new String[] { "Seventh Semester", "Eighth Semester"};    
        ...
        {
           case 0:  
        	   Intent newActivity0 = new Intent(getBaseContext(), Sem7Sub.class);     
                    startActivity(newActivity0);
                    break;
           case 1:  Intent newActivity1 = new Intent(getBaseContext(), Sem8Sub.class);     
