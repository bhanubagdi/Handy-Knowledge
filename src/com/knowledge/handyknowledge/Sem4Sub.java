...
public class Sem4Sub extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //----------------------------------------------------
       setContentView(R.layout.first); 
        ...
        String[] subjects = new String[] {"Engineering Maths - III","Object Oriented and multicore Programming","Microprocessors and Interfacing Techniques","Computer Graphics and Gaming","Computer Organization"};    
