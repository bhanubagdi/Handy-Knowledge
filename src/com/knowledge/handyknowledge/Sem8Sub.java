...
public class Sem8Sub extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //----------------------------------------------------
       setContentView(R.layout.first); 
        ...
        String[] subjects = new String[] {"Advanced Computer Architecture","Pattern Recognition","High Performance networks","Neural Networks","Advanced Databases","VLSI & Digital System Design","Operations Research","Cloud Computing","Information Security"};    
